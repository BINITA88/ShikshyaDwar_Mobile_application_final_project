...
//       otp: params.otp, role:  params.role, // Pass the OTP if provided
//     );
...
class RegisterUserParams extends Equatable {
  ...
  @override
  List<Object?> get props => [email, image, contactNo, name, password, otp, role];
}
...
class RegisterUseCase implements UsecaseWithParams<void, RegisterUserParams> {
  ...
  Future<Either<Failure, void>> call(RegisterUserParams params) async {
    ...
    final authEntity = AuthEntity(
      ...
      password: params.password,
      otp: params.otp,
      role: params.role, // ✅ Ensure role is passed
    );
