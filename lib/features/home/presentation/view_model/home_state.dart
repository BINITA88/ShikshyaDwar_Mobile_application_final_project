...
class HomeState extends Equatable {
  final int selectedIndex;
  final List<Widget> views;
  final int userRole; // ✅ Added userRole to manage role-based views
  final int currentCarouselIndex;
  final List<String> carouselImages;
  final List<Map<String, String?>> products;
  ...
  // ✅ **Ensure `views` and content are properly divided based on role**
  static HomeState initial(int role) {
    List<Widget> studentViews = [
      const DashboardView(),
      const ExamSeatScreen(),
      const RoutineScreen(),
      const NoticeViewPage(),
...
// ✅ Message should be displayed first
    ...
    return HomeState(
      selectedIndex: 0,
      views: (role == 0) ? studentViews : instructorViews,
      userRole: role,
      carouselImages: role == 0
          ? [
              'assets/images/imagee.png',
              'assets/images/imageee.png',
              'assets/images/image.png',
            ]
          : [], // No carousel for instructor
      products: role == 0
          ? [
              {
                "image": "assets/images/imagee.png",
                "title": "IELTS Class",
                "date": "10 Dec 2024",
                "duration": "2 Months",
              },
          ...
          : [], // No category products for instructor
    );
  }
